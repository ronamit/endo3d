...
from geo_fun import z_depth_map_to_point_cloud, plot_3d_point_cloud
...
def main():
    ...
    point_cloud = z_depth_map_to_point_cloud(z_depth_frame, metadata)

    plot_3d_point_cloud(point_cloud, title='')
    pass
